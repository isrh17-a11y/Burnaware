      ...
      <div className="w-full max-w-md">
        {/* Logo/Title */}
          <div className="text-center mb-8 animate-fadeIn">
            ...
            <h1 className="text-4xl font-bold text-[#763A12] mb-2">Welcome</h1>
            <p className="text-[#763A12]/80 text-lg">Your mental wellness journey continues</p>
          </div>
        ...
        <div className="bg-[#F2EEEC]/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-[#763A12]/5 p-8 animate-fadeIn border border-[#763A12]/10">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              {isLogin ? 'Access your dashboard' : 'Start tracking your wellness today'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-900 placeholder-gray-400"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#AA4C0A] to-[#E08600] text-white py-3.5 rounded-xl font-semibold hover:shadow-lg hover:shadow-[#E08600]/20 transform hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
